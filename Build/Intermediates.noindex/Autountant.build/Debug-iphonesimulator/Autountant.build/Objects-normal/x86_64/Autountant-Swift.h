...
#ifndef AUTOUNTANT_SWIFT_H
#define AUTOUNTANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Autountant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Autountant11AppDelegate")
...
SWIFT_CLASS("_TtC10Autountant14InputTextField")
...
SWIFT_CLASS("_TtC10Autountant13SceneDelegate")
...
SWIFT_CLASS("_TtC10Autountant21TappableLabelListView")
@interface TappableLabelListView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


@interface TappableLabelListView (SWIFT_EXTENSION(Autountant)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface VehiclesViewController (SWIFT_EXTENSION(Autountant)) <UITableViewDelegate>
